...
const MainContent = () => {
  ...
  return (
    <div className="px-30 py-10 mx-auto max-w-8xl flex-col flex-grow min-h-screen">
      <div className="flex justify-between items-center">
        <div className="flex flex-col space-y-2">
          <p className="text-3xl font-semibold">My Journal</p>
...

{
  entryCount > 0 ? <Cards/> :  (
            <div className="flex flex-col gap-3 items-center justify-center h-[350px]">
              ...
              <p className="text-slate-500 text-md">Start your journaling journey by creating your first entry.</p>
              <div>
          <button
            onClick={() => navigate("/new")}
            className={`${
